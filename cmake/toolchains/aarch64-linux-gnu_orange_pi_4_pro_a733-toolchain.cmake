# Orange Pi 4 Pro (Allwinner A733) 交叉工具链 (gcc-arm-11.2-2022.02)
...
set(TOOLCHAIN_ROOT "/opt/toolchains/gcc-arm-11.2-2022.02-x86_64-aarch64-none-linux-gnu" CACHE PATH "Orange Pi 4 Pro A733 toolchain root")
...
set(THIRD_PARTY_PLATFORM_TAG "aarch64-linux-gnu_orange_pi_4_pro_a733" CACHE STRING "Third-party install platform tag")
...
# 全志 NPU；VIPLite 版本由 FindAwnn 平台表与 AWNN_PLATFORM 对应（当前 a733 → v2.0）
set(AWNN_PLATFORM "a733" CACHE STRING "Allwinner AWNN platform id")
...
message(STATUS "==============================================================================")
message(STATUS "aarch64-linux-gnu_orange_pi_4_pro_a733 toolchain:")
...
message(STATUS "  AWNN_PLATFORM            = ${AWNN_PLATFORM}")
