...
int main()
{
    std::string path_model_rknn = "runs/models/RK3588/yolov5s_seg.rknn";
    std::string path_input_img = "apps/yolov5_seg_rknn/bus.jpg";
    std::filesystem::path path_model_output_npz = "apps/yolov5_seg_rknn/yolov5_seg_result_model_outputs.npz";

    std::string path_save_output_img = "tmp/yolov5_seg_out.jpg";
    std::filesystem::path path_save_model_output_npz = "tmp/yolov5_seg_result_model_outputs.npz";
    ...
    deploy_percept::utils::drawDetectionResults(result_img, seg_results);
